...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--use-llm", action="store_true", help="Usa Claude para extrair fatores macro, se houver chave.")
    parser.add_argument("--markdown", action="store_true", help="Imprime apenas o relatório Markdown.")
    parser.add_argument("--save", action="store_true", help="Salva JSON e Markdown em app/output.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        output = run_analysis(scenario, settings=settings, use_llm=args.use_llm)
